    ...
    <div className="flex items-center justify-between pr-0.5">
      <Link
        ...
        className={`flex items-center gap-3 px-2.5 py-2.5 ${
          isActive
            ? "bg-white text-primary w-[89%] rounded-lg"
            : "text-[#a4b0c3] w-full hover:bg-white hover:bg-opacity-10 hover:rounded-lg hover:w-[89%]"
        }`}
      >
        <Icon
          name={icon}
      ...
      {isActive && <div className="w-[6px] h-10 bg-white rounded-[40px]"></div>}
    </div>
  );
};
