...
import { useEffectFetch, usePaginatedEffect } from "@/hooks/useEffectFetch";
...
const SettlementHistory = () => {
  ...
  // Replace problematic useEffect with optimized hooks
  useEffectFetch(
    fetchBankDetails,
    [],
    {
                ...
                {settlements?.map((item: any, index: number) => (
                  ...
                  >
                    ...
                    <td className="text-xs px-5 py-6">
                      <div
                        className={`text-center rounded-lg py-1 px-3 ${item.settlement_status === "Approved" ||
                    ...
                    <td className="text-xs px-5 py-6">
                      <div
                        className={`text-center rounded-lg py-1 px-3 ${item.approval_status === "Approved"
                            ? "text-success bg-[#E9F7EF]"
                            : "text-danger bg-[#e0440326]"
                          }`}
                      >
